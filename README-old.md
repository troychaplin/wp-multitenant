...
Once the composer update has finished, navigate to the `config` folder and edit the `.env` to change `CURRENT_DOMAIN` to the domain you provided when setting up you.
